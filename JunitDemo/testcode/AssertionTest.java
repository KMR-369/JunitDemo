...
public class AssertionTest 
{
	...
	public void test() 
	{
		...
		assertNull(string5);       //  Asserts is a string is null      
		assertTrue(variable1 < variable2);   //Asserts if given condition is true          
		assertArrayEquals(airethematicArrary1, airethematicArrary2);    //Asserts two arrays if they are equal
	}
